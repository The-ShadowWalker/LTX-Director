...
ADV_FIELD_ORDER: List[str] = [
    ...
    # Misc
    "RIFLEx_setting", "force_fps", "num_inference_steps",
    "resolution_group", "resolution", "video_length",
]
...
ADV_FIELD_HELP: Dict[str, str] = {
    ...
    "resolution_group": "Resolution tier (e.g. 480p, 720p) that filters the budget list. Saved and restored with your session.",
