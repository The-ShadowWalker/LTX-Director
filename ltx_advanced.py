...
ADV_FIELD_ORDER: List[str] = [
    ...
    # Misc
    "RIFLEx_setting", "force_fps", "num_inference_steps", "resolution", "video_length",
]
            ...
            with gr.Row():
                ...
                c["multi_prompts_gen_type"] = gr.Dropdown(
                    choices=[
                        ...
                        ("Will be used for a new Sliding Window", 1),
                    ],
                    value=0, label="How to Process each Line of the Text Prompt", allow_custom_value=True)
